        ...
        <div className="flex flex-col justify-between space-y-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/md-tanjid-khan" target="_blank" rel="noopener noreferrer" className="btn btn-outline btn-circle btn-primary hover:text-white">
